            ...
            <main>
                ...
                <section className="text-center py-16 md:py-20 px-6 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-gray-900/80 via-zinc-950 to-zinc-950">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <h1 className="text-4xl md:text-7xl font-black tracking-tighter leading-tight text-white">Ter a casa dos seus sonhos em Camaquã custa <span className="text-lime-400">muito menos</span> do que te contaram.</h1>
                        <p className="mt-8 text-lg md:text-xl text-gray-400 max-w-3xl mx-auto">A verdade é que a falta de um plano custa caro. Descubra como uma consultoria inicial inteligente pode transformar seu lar com um orçamento que você pode pagar.</p>
                    </div>
                </section>

                {/* Seção 2: A Isca */}
                <section className="bg-black py-16 md:py-20 px-6 text-center">
                    <div className="max-w-5xl mx-auto">
                        <h2 className="text-3xl md:text-5xl font-bold text-white">Tudo começa com o <span className="text-lime-400">Diagnóstico Estratégico</span> do seu Lar.</h2>
                        <p className="mt-6 text-lg text-gray-400 max-w-3xl mx-auto">Chega de conversas vagas. Em uma única visita à sua casa, vamos fazer um raio-x do seu espaço e, ao final, você recebe um documento tangível: um Croqui de Soluções em PDF. É o seu primeiro plano de ataque, com um desenho-esboço do novo layout e as ações de maior impacto para transformar seu ambiente.</p>
                ...
                <section className="py-16 md:py-20 px-6">
                     <div className="max-w-5xl mx-auto text-center">
                        <h2 className="text-3xl md:text-5xl font-bold text-white">Chega de "adiar seu sonho". É hora de ter um <span className="text-lime-400">Plano de Batalha</span>.</h2>
                        <p className="mt-6 text-lg text-gray-400 max-w-3xl mx-auto">Esqueça o "designer de luxo". Eu sou um Especialista em Planejamento Residencial. Minha missão é uma só: criar um guia, um mapa exato para a sua casa, que te faz economizar em cada etapa. Eu encontro os materiais certos pelo preço certo, defino o layout que aproveita cada centímetro e te impeço de cometer erros caros.</p>
                        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mt-12">
                            <div className="border border-gray-800 p-4 rounded-lg flex items-center gap-4">
                                <DollarSignIcon className="w-8 h-8 text-lime-400 flex-shrink-0"/>
                                <p className="text-white font-semibold">Custo-Benefício Real</p>
                            </div>
                             <div className="border border-gray-800 p-4 rounded-lg flex items-center gap-4">
                                <MapIcon className="w-8 h-8 text-lime-400 flex-shrink-0"/>
                                <p className="text-white font-semibold">Layout Inteligente</p>
                            </div>
                             <div className="border border-gray-800 p-4 rounded-lg flex items-center gap-4">
                                <ShieldIcon className="w-8 h-8 text-lime-400 flex-shrink-0"/>
                                <p className="text-white font-semibold">Prevenção de Erros</p>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="bg-black py-16 md:py-20 px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-bold text-white">Um Plano de Ação para Cada Necessidade</h2>
                            <p className="mt-4 text-lg text-gray-400 max-w-3xl mx-auto">Após nosso Diagnóstico Estratégico, montamos o plano ideal para você. Veja abaixo as soluções que ofereço:</p>
                        </div>
                ...
                <section className="py-16 md:py-20 px-6">
                    <div className="max-w-6xl mx-auto">
                        <div className="text-center mb-16">
                            <h2 className="text-3xl md:text-5xl font-bold text-white">Veja o que um bom plano e <span className="text-lime-400">pouco investimento</span> podem fazer.</h2>
                        </div>
                ...
                <section className="py-16 md:py-20 px-6">
                    <div className="max-w-4xl mx-auto">
                        <div className="text-center">
                            <h2 className="text-3xl md:text-5xl font-bold text-white">Sua transformação começa agora. <span className="text-lime-400">A decisão é sua.</span></h2>
                        ...
                        <div className="grid md:grid-cols-2 gap-8 my-16">
                            <div className="bg-zinc-900 p-8 rounded-lg border border-gray-800 text-center">
                                ...
                                <div className="my-6 text-5xl font-black text-white">R$ 39</div>
                             ...
                             <div className="bg-zinc-900 p-8 rounded-lg border border-gray-800 text-center">
                                ...
                                <div className="my-6 text-3xl font-black text-white">A partir de <span className="text-5xl">R$ 140</span></div>
                        ...
                        <div className="mt-16 bg-black p-8 sm:p-12 rounded-lg border border-gray-800">
                            ...
                            <form className="space-y-6">
                                ...
                                <button type="submit" className="w-full bg-lime-400 text-black font-bold text-lg py-4 rounded-lg hover:bg-lime-300 transition-all transform hover:scale-[1.03] shadow-lg shadow-lime-400/30 hover:shadow-lime-300/40 relative overflow-hidden group">
